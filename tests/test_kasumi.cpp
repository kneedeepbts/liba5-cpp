...
TEST_CASE("Testing the Kasumi class with (3.4) Test Set 2") {
    spdlog::set_level(spdlog::level::info);
    kneedeepbts::crypto::KasumiKey key{0x8CE3, 0x3E2C, 0xC3C0, 0xB5FC, 0x1F3D, 0xE8A6, 0xDC66, 0xB1F3};
...
TEST_CASE("Testing the Kasumi class with (3.5) Test Set 3") {
    spdlog::set_level(spdlog::level::info);
    kneedeepbts::crypto::KasumiKey key{0x4035, 0xC668, 0x0AF8, 0xC6D1, 0xA8FF, 0x8667, 0xB171, 0x4013};
...
TEST_CASE("Testing the Kasumi class with (3.6) Test Set 4 (50 iterations)") {
    spdlog::set_level(spdlog::level::info);
    kneedeepbts::crypto::KasumiKey key{0x3A3B, 0x39B5, 0xC3F2, 0x376D, 0x69F7, 0xD546, 0xE5F8, 0x5D43};
